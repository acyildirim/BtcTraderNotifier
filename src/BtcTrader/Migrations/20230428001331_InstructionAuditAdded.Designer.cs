...
namespace BtcTrader.Migrations
{
    ...
    [Migration("20230428001331_InstructionAuditAdded")]
    partial class InstructionAuditAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BtcTrader.Domain.Instructions.InstructionAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("InstructionAudit");
                });

            modelBuilder.Entity("BtcTrader.Domain.User.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BtcTrader.Domain.User.AppUser", null)
                        .WithMany()
